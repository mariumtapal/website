...
This project uses a parameterized R Markdown report and a simple function to perform the magic! You can look at the code and read more about it in the GitHub repo [here](https://github.com/mariumtapal/bayes-regression-report).
